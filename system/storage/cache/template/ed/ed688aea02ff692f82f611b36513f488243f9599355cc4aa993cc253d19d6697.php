...
class __TwigTemplate_96f4579771595cf4598d81ee7d8ab4d59a0ca127f3b91f7eebebaeaeabb32dae extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <table class=\"table table-striped\">
        ";
          ...
          <td class=\"text-center\"><button type=\"button\" onclick=\"cart.remove('";
                ...
                echo "\" class=\"btn btn-danger btn-xs\"><i class=\"fa fa-trash\" aria-hidden=\"true\"></i></button></td>
        </tr>
        ";
            }
            $_parent = $context['_parent'];
